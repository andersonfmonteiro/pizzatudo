...
const PaymentForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const { error: backeEndError, clientSecret } = await fetch('http://127.0.0.1:8080/create-payment-intent', {
                method: 'POST',
                headers: {
        ...
        return(
            ...
            <label htmlFor="card-element" className="pt-4 text-2xl md:text-center">insira os dados de seu cartão</label>
            <div className="my-4">
